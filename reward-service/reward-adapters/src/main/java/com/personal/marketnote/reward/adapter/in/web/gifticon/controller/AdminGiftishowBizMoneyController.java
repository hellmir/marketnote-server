...
public class AdminGiftishowBizMoneyController {
    ...
    private final GetGiftishowBizMoneyBalanceUseCase getGiftishowBizMoneyBalanceUseCase;
    ...
    public ResponseEntity<BaseResponse<GetGiftishowBizMoneyBalanceResponse>> getBalance() {
        GetGiftishowBizMoneyBalanceResult result = getGiftishowBizMoneyBalanceUseCase.getBalance();
