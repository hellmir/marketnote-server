...
@Operation(
        ...
        description = """
                ...
                ## Description
                - 인증된 사용자의 배송지 목록을 조회합니다.
                
                - **기본 배송지**가 최상단에 노출되며, 이후 **HOME → COMPANY → OTHER** 순으로 정렬됩니다.
                ...
                | **키** | **타입** | **설명** | **예시** |
                | --- | --- | --- | --- |
                | shippingAddresses | array | 배송지 목록 | [ ... ] |
                
                ---
                
                #### Response > content > shippingAddresses
...
public @interface GetMyShippingAddressesApiDocs {
}
