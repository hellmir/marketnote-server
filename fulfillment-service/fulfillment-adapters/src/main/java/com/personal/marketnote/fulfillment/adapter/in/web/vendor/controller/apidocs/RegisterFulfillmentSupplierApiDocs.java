...
@Operation(
        ...
        description = """
                ...
                | **키** | **타입** | **설명** | **필수 여부** | **예시** |
                | --- | --- | --- | --- | --- |
                | supplierName | string | 공급사명 | Y | "테스트 공급사1" |
                | customerSupplierCode | string | 고객사 공급사 코드 | N | "" |
                | useYn | string | 사용여부 | N | "" |
        ...
        requestBody = @RequestBody(
                required = true,
                content = @Content(
                        schema = @Schema(implementation = RegisterFulfillmentSupplierRequest.class),
                        examples = @ExampleObject("""
                                {
                                  "customerSupplierCode": "",
                                  "supplierName": "테스트 공급사1",
                                  "useYn": "",
                                  "dealStartDate": "",
                                  "dealEndDate": "",
                                  "zipCode": "12345",
...
public @interface RegisterFulfillmentSupplierApiDocs {
}
