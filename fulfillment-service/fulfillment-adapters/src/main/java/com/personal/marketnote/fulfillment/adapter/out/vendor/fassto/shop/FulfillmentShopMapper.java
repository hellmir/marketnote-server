...
public class FulfillmentShopMapper {
    ...
    public static FulfillmentShopMapper register(
            String customerCode,
            String accessToken,
            String shopNm,
            String cstShopCd,
    ...
    public static FulfillmentShopMapper update(
            String customerCode,
            String accessToken,
            String shopCd,
            String shopNm,
    ...
    private void validate() {
        ...
        if (FormatValidator.hasNoValue(shopCd)) {
            throw new FulfillmentQueryParameterNoValueException("shopCd", "shop request");
        }
        if (FormatValidator.hasNoValue(shopNm)) {
            throw new FulfillmentQueryParameterNoValueException("shopNm", "shop request");
        }
    }
    ...
    private static FulfillmentShopMapper create(
            String customerCode,
            String accessToken,
            String shopCd,
            String shopNm,
        ...
        FulfillmentShopMapper mapper = FulfillmentShopMapper.builder()
