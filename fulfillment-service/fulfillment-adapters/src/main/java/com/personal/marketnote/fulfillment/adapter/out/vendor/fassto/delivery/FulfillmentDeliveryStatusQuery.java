...
public class FulfillmentDeliveryStatusQuery {
    ...
    public static FulfillmentDeliveryStatusQuery of(
            String customerCode,
            String accessToken,
            String startDate,
            String endDate,
        ...
        FulfillmentDeliveryStatusQuery query = FulfillmentDeliveryStatusQuery.builder()
