...
import com.personal.marketnote.fulfillment.adapter.in.web.vendor.request.RegisterFasstoDeliveryIcsRequest;
...
@Operation(
        ...
        description = """
                ...
                | **키** | **위치** | **타입** | **설명** | **필수 여부** | **예시** |
                | --- | --- | --- | --- | --- | --- |
                | accessToken | header | string | 파스토 액세스 토큰 | Y | 5b835fb0f4d711f0be620ab49498ff55 |
        ...
        parameters = {
                @Parameter(
                        ...
                        required = true,
                        schema = @Schema(type = "string", example = "5b835fb0f4d711f0be620ab49498ff55")
                ),
                @Parameter(
                        name = "customerCode",
        ...
        requestBody = @RequestBody(
                required = true,
                content = @Content(
                        schema = @Schema(implementation = RegisterFasstoDeliveryIcsRequest.class),
...
public @interface RegisterFasstoDeliveryIcsApiDocs {
}
