...
public interface RegisterFulfillmentDirectReturnDeliveryPort {
    ...
    /**
     * @param request 파스토 직접 반품 등록 요청 매퍼
     * @return 파스토 직접 반품 등록 결과 {@link RegisterFulfillmentDeliveryResult}
     * @Date 2026-02-20
     * @Author 성효빈
     * @Description 파스토 직접 반품을 등록합니다.
     */
    RegisterFulfillmentDeliveryResult registerDirectReturnDelivery(FulfillmentDirectReturnDeliveryMapper request);
}
