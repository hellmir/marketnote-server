...
public interface GetFulfillmentWarehousingAbnormalImagePort {
    ...
    /**
     * @param command 풀필먼트 입고 이상 이미지 조회 커맨드
     * @return 풀필먼트 입고 이상 이미지 조회 결과 {@link GetFulfillmentWarehousingAbnormalImageResult}
     * @Date 2026-02-17
     * @Author 성효빈
     * @Description 풀필먼트 입고 이상 이미지를 조회합니다.
     */
