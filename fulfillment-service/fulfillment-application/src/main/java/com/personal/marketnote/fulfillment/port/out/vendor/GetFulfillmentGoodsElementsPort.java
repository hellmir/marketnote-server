 ...
 * @Author 성효빈
 * @Date 2026-01-30
 * @Description 풀필먼트 상품 구성 요소 조회 기능을 제공합니다.
 */
public interface GetFulfillmentGoodsElementsPort {

    /**
     * @param command 풀필먼트 상품 구성 요소 조회 커맨드
     * @return 풀필먼트 상품 구성 요소 조회 결과 {@link GetFulfillmentGoodsElementsResult}
     * @Date 2026-01-30
     * @Author 성효빈
     * @Description 풀필먼트 상품 구성 요소를 조회합니다.
     */
