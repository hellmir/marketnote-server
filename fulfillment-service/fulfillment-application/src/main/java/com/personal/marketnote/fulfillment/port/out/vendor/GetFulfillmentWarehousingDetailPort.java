 ...
 * @Author 성효빈
 * @Date 2026-02-14
 * @Description 풀필먼트 입고 상세 조회 기능을 제공합니다.
 */
public interface GetFulfillmentWarehousingDetailPort {

    /**
     * @param command 풀필먼트 입고 상세 조회 커맨드
     * @return 풀필먼트 입고 상세 조회 결과 {@link GetFulfillmentWarehousingDetailResult}
     * @Date 2026-02-14
     * @Author 성효빈
     * @Description 풀필먼트 입고 상세 정보를 조회합니다.
     */
