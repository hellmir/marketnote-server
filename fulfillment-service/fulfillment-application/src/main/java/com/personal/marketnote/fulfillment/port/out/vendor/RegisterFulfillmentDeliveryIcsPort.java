...
import com.personal.marketnote.fulfillment.domain.vendor.delivery.FulfillmentDeliveryIcsMapper;
...
public interface RegisterFulfillmentDeliveryIcsPort {
     ...
     * @return 파스토 출고 ICS 등록 결과 {@link RegisterFulfillmentDeliveryResult}
     * @Date 2026-02-11
     * @Author 성효빈
     * @Description 파스토 출고 ICS를 등록합니다.
     */
    RegisterFulfillmentDeliveryResult registerDeliveryIcs(FulfillmentDeliveryIcsMapper request);
}
