...
public class FasstoDeliveryIcsMapper {
    private String customerCode;
    private String accessToken;
    private List<FasstoDeliveryIcsItemMapper> deliveryRequests;

    public static FasstoDeliveryIcsMapper register(
            String customerCode,
            String accessToken,
            List<FasstoDeliveryIcsItemMapper> deliveryRequests
    ) {
        FasstoDeliveryIcsMapper mapper = FasstoDeliveryIcsMapper.builder()
    ...
    public List<Map<String, Object>> toPayload() {
        return deliveryRequests.stream()
                .map(FasstoDeliveryIcsItemMapper::toPayload)
                .toList();
    }
