package com.personal.marketnote.fulfillment.domain.vendor.supplier;
...
public class FulfillmentSupplierMapper {
    ...
    public static FulfillmentSupplierMapper register(
            String customerCode,
            String accessToken,
            String supNm,
            String cstSupCd,
    ...
    public static FulfillmentSupplierMapper update(
            String customerCode,
            String accessToken,
            String supCd,
            String supNm,
    ...
    private void validate() {
        ...
        if (FormatValidator.hasNoValue(supCd)) {
            throw new FulfillmentQueryParameterNoValueException("supCd", "supplier request");
        }
        if (FormatValidator.hasNoValue(supNm)) {
            throw new FulfillmentQueryParameterNoValueException("supNm", "supplier request");
        }
    }
    ...
    private static FulfillmentSupplierMapper create(
            String customerCode,
            String accessToken,
            String supCd,
            String supNm,
        ...
        FulfillmentSupplierMapper mapper = FulfillmentSupplierMapper.builder()
