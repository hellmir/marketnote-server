...
class ReviewWriteRequestNotificationConsumerTest {

    @InjectMocks
    private ReviewWriteRequestNotificationConsumer consumer;
    ...
    @Test
    @DisplayName("구매 확정 이벤트 수신 시 리뷰 작성 요청 알림을 예약 발송하고 acknowledge한다")
    void shouldSendScheduledReviewRequestNotificationAndAcknowledge() {
        // given
        ...
        assertThat(command.templateCode()).isEqualTo("REVIEW_WRITE_REQUEST");
