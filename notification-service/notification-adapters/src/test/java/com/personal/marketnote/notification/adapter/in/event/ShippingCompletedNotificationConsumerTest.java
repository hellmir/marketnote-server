...
class ShippingCompletedNotificationConsumerTest {

    @InjectMocks
    private ShippingCompletedNotificationConsumer consumer;
    ...
    @Test
    @DisplayName("배송 상태 DELIVERED 이벤트 수신 시 SendNotificationUseCase를 호출하고 acknowledge한다")
    void shouldSendNotificationAndAcknowledgeWhenDeliveredStatus() {
        // given
        ...
        assertThat(command.templateCode()).isEqualTo("SHIPPING_COMPLETED");
