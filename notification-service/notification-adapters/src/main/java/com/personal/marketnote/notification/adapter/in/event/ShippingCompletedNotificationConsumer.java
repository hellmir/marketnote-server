...
public class ShippingCompletedNotificationConsumer {
    ...
    public void handleShippingStatusChangedEvent(
        ...
        log.info("배송 완료 이벤트 수신 (알림 발송). eventId={}, orderId={}, buyerId={}",
        ...
        try {
            ...
            log.info("배송 완료 알림 발송 완료. orderId={}, buyerId={}", payload.orderId(), payload.buyerId());
        } catch (Exception e) {
            log.error("배송 완료 알림 발송 실패. eventId={}, orderId={}, buyerId={}, error={}",
