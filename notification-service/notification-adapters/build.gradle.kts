...
group = "com.personal.marketnote.notification.adapters"
version = "1.0.0"
description = "notification service adapters"
...
dependencies {
    ...
    implementation(project(":notification-service:notification-application"))
    implementation(project(":notification-service:notification-domain"))
...
springBoot {
    mainClass.set("com.personal.marketnote.notification.NotificationApplication")
    buildInfo()
}
